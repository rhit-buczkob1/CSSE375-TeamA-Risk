...
public class AlternatePhaseController extends PhaseController {
    ...
    public AlternatePhaseController(PlayerController playerController, GameBoardController gameBoardController) {
        super(playerController, gameBoardController);
        phase = "setup";
